...
int main(int argc, char** argv) {
	if (argc != 2) {
		...
		graph_node *a = graph_add_node(gra, (void*)"a");
		graph_node *b = graph_add_node(gra, (void*)"b");
		graph_node *c = graph_add_node(gra, (void*)"c");
		graph_node *d = graph_add_node(gra, (void*)"d");
